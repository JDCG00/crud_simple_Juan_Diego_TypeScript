class Controlador {
    ...
    crear() {
        ...
        let poblacion = parseInt(this.iPoblacion.value);
    ...
    editar(pais) {
        ...
        this.iEditarPoblacion.value = String(pais.poblacion);
        this.paisEditado = pais;
        this.divEditar.style.display = 'block';
    }
    modificar() {
        this.paisEditado.nombre = this.iEditarNombre.value;
        this.paisEditado.poblacion = parseInt(this.iEditarPoblacion.value);
        this.cancelar();
        this.mostrar();
    }
    cancelar() {
